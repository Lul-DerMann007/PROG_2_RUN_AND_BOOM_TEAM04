...
class Checkpoint(pg.sprite.Sprite):
    ...
    def check_reached(self,runner):
        ...
        if runner.pos.x >= self.rect.left:   #Bugfix mit ChatGPT. Prompt: Ich habe diese Funktion zur Checkpoint Erreichung erstellt. Ich bekomme eine Fehlermeldung, das ich string nicht mit tupel vergleichen kann. Wie kann ich die Mitte des Checkpoints vergleichen?
